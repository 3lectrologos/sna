...
\begin{figure}[tb]
  ...
  \caption{Different stages of the simulation for the ER(50, 0.3)
    graph of Figure~\ref{fig:graph_er}.}
...
\begin{figure}[tb]
  \begin{subfigure}[b]{0.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/ER_evo_500_003}
  \end{subfigure}
  \begin{subfigure}[b]{0.5\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/ER_evo_500_007}
  \end{subfigure}
